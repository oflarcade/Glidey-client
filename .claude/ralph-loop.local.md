...
active: true
iteration: 1
session_id: 05928b08-bb39-4311-b50b-1f3ebf8e2dea
max_iterations: 20
completion_promise: "CAVEKIT COMPLETE"
started_at: "2026-04-22T12:14:27Z"
---
...
2. `context/plans/build-site-trip-receipt-rating.md` — the task dependency graph
3. Impl tracking files in `context/impl/` — but ONLY files that are scoped to this build site.
   An impl file is scoped if it contains `Build site: context/plans/build-site-trip-receipt-rating.md` (or the matching basename).
